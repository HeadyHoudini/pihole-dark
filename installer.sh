...
while true; do
    ...
    case $yn in
        [Yy]|""* ) 
				...
				cp -f admin/scripts/pi-hole/js/auditlog.js admin/scripts/pi-hole/js/auditlog.js.orig
				...
				cp -f admin/scripts/pi-hole/js/db_queries.js admin/scripts/pi-hole/js/db_queries.js.orig
				...
				cp -f admin/db_queries.php admin/db_queries.php.orig
...
while true; do
    ...
    case $yn in
        [Yy]|""* ) 
				...
				cp temp/scripts/pi-hole/js/auditlog.js admin/scripts/pi-hole/js/auditlog.js
				...
				cp temp/scripts/pi-hole/js/db_queries.js admin/scripts/pi-hole/js/db_queries.js
				...
				cp temp/db_queries.php admin/db_queries.php
