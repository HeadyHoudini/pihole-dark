        ...
        for (domain in data.top_queries) {
            if ({}.hasOwnProperty.call(data.top_queries,domain)){
                ...
                domaintable.append("<tr> <td>" + url +
                    "</td> <td>" + data.top_queries[domain] + "</td> <td> <button style=\"color:"+cRed+"; white-space: nowrap;\"><i class=\"fa fa-ban\"></i> Blacklist</button> <button style=\"color:"+cOrange+"; white-space: nowrap;\"><i class=\"fa fa-balance-scale\"></i> Audit</button> </td> </tr> ");
            }
        }
        ...
        for (domain in data.top_ads) {
            if ({}.hasOwnProperty.call(data.top_ads,domain)){
                ...
                if(input.length > 1)
                {
                    ...
                    "</td> <td>" + data.top_ads[domain] + "</td> <td> <button style=\"color:"+cOrange+"; white-space: nowrap;\"><i class=\"fa fa-balance-scale\"></i> Audit</button> </td> </tr> ");
                }
                else
                {
                    url = "<a href=\"queries.php?domain="+printdomain+"\">"+printdomain+"</a>";
                    adtable.append("<tr> <td>" + url +
                    "</td> <td>" + data.top_ads[domain] + "</td> <td> <button style=\"color:"+cGreen+"; white-space: nowrap;\"><i class=\"fas fa-check\"></i> Whitelist</button> <button style=\"color:"+cOrange+"; white-space: nowrap;\"><i class=\"fa fa-balance-scale\"></i> Audit</button> </td> </tr> ");
                }
            }
        }
