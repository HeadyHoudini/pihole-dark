    ...
    tableApi = $("#all-queries").DataTable( {
        "rowCallback": function( row, data, index ){
            ...
            switch (data[5])
             {
            case "1":
                dnssec_status = "<br><span style=\"color:"+cGreen+"\">SECURE</span>";
                break;
            case "2":
                dnssec_status = "<br><span style=\"color:"+cOrange+"\">INSECURE</span>";
                break;
            case "3":
                dnssec_status = "<br><span style=\"color:"+cRed+"\">BOGUS</span>";
                break;
            case "4":
                dnssec_status = "<br><span style=\"color:"+cRed+"\">ABANDONED</span>";
                break;
            case "5":
                dnssec_status = "<br><span style=\"color:"+cOrange+"\">UNKNOWN</span>";
                break;
            default: // No DNSSEC
                dnssec_status = "";
            }
            ...
            case "1":
                ...
                buttontext = "<button style=\"color:"+cGreen+"; white-space: nowrap;\"><i class=\"fas fa-check\"></i> Whitelist</button>";
                break;
            case "2":
                blocked = false;
                color = cGreen;
                fieldtext = "OK <br class='hidden-lg'>(forwarded)"+dnssec_status;
                buttontext = "<button style=\"color:"+cRed+"; white-space: nowrap;\"><i class=\"fa fa-ban\"></i> Blacklist</button>";
                break;
            case "3":
                blocked = false;
                color = cGreen;
